...
namespace OfflineServer
{
    public static class CarDefinitions
    {
        ...
        public static readonly Dictionary<Int64, String> physicsProfileHashNormal = new Dictionary<Int64, String>()
        {
            ...
            {117677212, "MERCEDES-BENZ SLR MCLAREN STIRLING MOSS"},
        ...
        public static readonly Dictionary<Int64, String> physicsProfileHashReversed = new Dictionary<Int64, String>()
        {
            ...
            {-4177290084, "MERCEDES-BENZ SLR MCLAREN STIRLING MOSS"},
        ...
        public static readonly Dictionary<Int64, String> baseCarId = new Dictionary<Int64, String>()
        {
            ...
            {41998979, "BMW 1 SERIES M COUPE"},
            {-1507688326, "BMW 3.0 CSL GR.5"},
            {-1967974518, "BMW M1 PROCAR"},
            {1816135925, "BMW M3 (E92)"},
            {1816139026, "BMW M3 GTR (E46)"},
            {1816139027, "BMW M3 GTS (E92)"},
            {1816135725, "BMW M3 SPORT EVOLUTION (E30)"},
            {-193545762, "BMW M6 CABRIOLET"},
            ...
            {-691868226, "CATERHAM SUPERLIGHT R500"},
            {1410528946, "CHEVROLET CAMARO SS"},
            {974805577, "CHEVROLET CAMARO ZL1"},
            {16618735, "CHEVROLET CAMARO ZL1 ELITE EDITION"},
            {-1370575257, "CHEVROLET CHEVELLE SS"},
            {-691868325, "CHEVROLET COBALT SS"},
            {-1408763688, "CHEVROLET CORVETTE STINGRAY (C2)"},
            ...
            {700789, "CHRYSLER 300C HEMI V8"},
            {290872130, "DODGE CHALLENGER R/T CONCEPT"},
            {1008844988, "DODGE CHALLENGER R/T"},
            {990337002, "DODGE CHARGER R/T"},
            {1634713038, "DODGE CHARGER SRT-8 SUPER BEE"},
            {-1666705986, "DODGE VIPER SRT-10"},
            {1711519800, "DODGE VIPER ELUTE SRT-10 ACR"},
            {-691868288, "FORD CAPRI RS 3100"},
            {-947943862, "FORD CROWN VICTORIA POLICE INTERCEPTOR"},
            {-370786472, "FORD ESCORT RS COSWORTH"},
            {-691868358, "FORD Escort MK1 RS1600 FIA Group 2"},
            {-691868360, "FORD F-150 RAPTOR SVT"},
            {-1340228859, "FORD FOCUS RS"},
            {1544720613, "FORD GT"},
            {-1426430711, "FORD GT40"},
            {-691868290, "FORD POLICE INTERCEPTOR"},
            {-691868255, "FORD LOTUS CORTINA"},
            {-26123784, "FORD MUSTANG BOSS 302"},
            {-26123612, "FORD MUSTANG BOSS 302 '69"},
            {2020296126, "FORD MUSTANG RTR-X"},
            {529336918, "FORD SHELBY GT500 SUPER SNAKE"},
            {1095591178, "FORD SHELBY TERLINGUA MUSTANG"},
            {-691868352, "HUMMER H1"},
            {-691868257, "HUMMER H1 SNOWFLAKE"},
            {43118, "INFINITI G35"},
            ...
            {-1606457066, "KOENIGSEGG CCX ELITE EDITION"},
            {-691868327, "KOENIGSEGG CCXR EDITION"},
            {-691868323, "LAMBORGHINI AVENTADOR LP 700-4"},
            ...
            {1305539024, "LAMBORGHINI MURCIELAGO LP 670-4 SUPERVELOCE"},
            {-691868420, "LAMBORGHINI REVENTON"},
            {-402882280, "LAMBORGHINI SESTO ELEMENTO"},
            {44072489, "LANCIA DELTA HF"},
            {46369, "LEXUS IS F"},
            {50476782, "LEXUS IS 300"},
            {50476947, "LEXUS IS 350"},
            {1106775043, "LEXUS LFA"},
            {45506673, "LOTUS ELISE 111R"},
            {1512713003, "LOTUS EUROPA S"},
            {45872540, "LOTUS EVORA"},
            {1146389329, "LOTUS EXIGE CUP 260"},
            {-691868387, "MARUSSIA B2"},
            {-87126832, "MAZDA MAZDASPEED 3 '08"},
            {55402337, "MAZDA MX-5 MIATA"},
            {56320, "MAZDA RX-7"},
            ...
            {-691868385, "MCLAREN MP4-12C 'BRAAAIIIINS' EDITION"},
            {-691868224, "MERCEDES-BENZ SLR MCLAREN STIRLING MOSS"},
            {2049908075, "MERCEDES-BENZ SLR MCLAREN 722 EDITION"},
            {-691868391, "MITSUBISHI ECLIPSE GS-T"},
            {-1546676681, "MITSUBISHI ECLIPSE GS-T ELITE EDITION"},
            ...
            {1589472076, "VOLKSWAGEN GOLF GTI"},
        ...
        /// <param name="checkForReversedPhysicsProfileHash">Whether to also check for negative entries.</param>
        ...
        public static String defineFromPhysicsProfileHash(Int64 physicsProfileHash, Boolean checkForReversedPhysicsProfileHash = true, Boolean checkForBaseCarId = false, Int64 baseCarId = 0)
        {
            String carMakeModel;
            if (!physicsProfileHashNormal.TryGetValue(physicsProfileHash, out carMakeModel))
            {
